...
<body>
    <form id="form1" runat="server">
        ...
        <div class="Datos">
            ...
            <div class="asp-validator">
                <asp:RegularExpressionValidator ID="regTxtFnaEmp" runat="server" ErrorMessage="El formato de los datos introducidos debe ser: Formato de fecha dd/mm/aaaa" ControlToValidate="txtFnaEmp" ForeColor="Green" ValidationExpression="\d\d\/\d\d\/\d\d\d\d"></asp:RegularExpressionValidator> <br />
