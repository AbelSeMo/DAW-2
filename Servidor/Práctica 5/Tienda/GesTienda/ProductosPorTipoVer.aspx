...
<asp:Content ID="Content2" ContentPlaceHolderID="InfoContenido" runat="server">
    ...
    <asp:GridView ID="grdTipos" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="IdTipo" DataSourceID="SqlDataSource1" HorizontalAlign="Center" PageSize="5" Width="50%">
    ...
    <div class="contenidotitulo">Productos</div> 
        <asp:GridView ID="grdProductos" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="IdProducto" DataSourceID="SqlDataSource2" HorizontalAlign="Center" Width="80%">
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>
